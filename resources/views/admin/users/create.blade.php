...
<div class="space-y-6">
    ...
    <div class="glass-effect rounded-lg p-4 flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-400 text-sm mt-1">Add a new user to the system with multiple roles</p>
        </div>
    ...
    <div class="glass-effect rounded-lg p-6">
        <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-6">
            ...
            <!-- Role Combinations Info -->
            <div class="bg-gray-800/50 rounded-lg p-4 space-y-2">
                <h4 class="font-medium text-gray-200">Common Role Combinations:</h4>
                <ul class="text-sm text-gray-400 space-y-1">
                    <li><strong class="text-blue-400">Planner + Grader:</strong> Can manage lesson plans and grade student work</li>
                    <li><strong class="text-purple-400">Viewer + Grader:</strong> Can view lesson plans and grade assignments</li>
                    <li><strong class="text-green-400">Grader only:</strong> Access limited to grading functionality</li>
                    <li><strong class="text-red-400">Admin:</strong> Usually assigned alone with full access</li>
                </ul>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Update role card styling when checkboxes change
